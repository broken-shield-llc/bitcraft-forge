...
5. `pnpm dev` — SpacetimeDB subscriber + Discord bot. Slash commands: `/forge health`, `/forge claim …`, `/forge building …` (claim/building need **Manage Server** and must be used in a guild).
